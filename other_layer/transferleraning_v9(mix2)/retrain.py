...
BOTTLENECK_TENSOR_NAME = 'mixed_1/join:0'
BATCH_SIZE=5
BOTTLENECK_TENSOR_SIZE=2048
#inceptionv3模型输出的shape
BOTTLENECK_TENSOR_SHAPE = [None,35,35,288]
...
def get_or_create_bottleneck(sess, image_lists, label_name, index, image_dir,
  ...
  try:
    ...
    bottleneck_values = np.squeeze(np.array(bottleneck_values).reshape((1,35,35,288)))
  except:
